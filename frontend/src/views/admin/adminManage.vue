          ...
          <div class="card">
            <div class="card-content">
              <div class="content">
                ...
                <router-link class="fs-5 float-end  me-2 btn btn-primary" :to="`/create/${tour.name}`"><span><i
                  ...
                  <div class="col-4" v-for="tour in tours" :key="tour.id">
                    ...
                    <div class="card-body my-2">
                      ...
                      <div class="text-right">
                        <router-link class="fs-4 text-black me-2" :to="`/edit/${tour._id}`"><span><i
                              class="bi bi-pencil-square"></i></span>
                        </router-link>
                        <span class="ms-1 fs-4" @click="deleteTour(tour._id)"> <i class="bi bi-trash3"></i></span>
                      </div>
                    </div>
                  </div>
                </div>
