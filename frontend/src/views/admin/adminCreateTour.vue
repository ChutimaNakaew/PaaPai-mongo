    ...
    <section class="section" id="app">
      <div class="d-flex justify-content-center">
        ...
        <div class="card" style="width: 60%;">
          <div class="card-body">
            <form action="https://paapai-mongo-backend.vercel.app/tours-create" method="POST">
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <b-form-datepicker id="example-datepicker" class="mb-2" locale="en"
                  name="date_first"></b-form-datepicker>
              </div>
              <div class="mb-3">
                <label for="example-datepicker">ครั้งที่2</label>
                <b-form-datepicker name="date_second" class="mb-2" locale="en"></b-form-datepicker>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="detail_img" class="form-control" />
              </div>
              <div class="mb-3">
                <label class="form-label">จำนวนผู้เดินทาง</label>
                <input type="text" name="max_tourist" class="form-control" />
              </div>
...
export default {
  ...
  methods: {
    getToursDetail(tourName) {
      axios
        .get(`https://paapai-mongo-backend.vercel.app/create/${tourName}`)
        .then(response => {
